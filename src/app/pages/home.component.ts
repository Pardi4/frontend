...
const HOME_LOCALE_TEXT: Record<Exclude<Locale, 'en' | 'pl'>, any> = {
  de: {
    ...
    proof: ['Universal-Parser + 10+ optimierte Plattformen', 'Notizen und Bilder werden mit Fragen gespeichert', 'Teilbare Quizze aus deiner Historie'],
  ...
  es: {
    ...
    proof: ['Parser universal + 10+ plataformas optimizadas', 'Notas e imágenes guardadas con preguntas', 'Quizzes compartibles desde el historial'],
