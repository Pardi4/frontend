...
const en: SiteCopy = {
  ...
  creditsPage: {
    ...
    metaDescription: "Top up QuizSolver credits with one-time packages. One credit equals one AI answer for a quiz question, with no subscription or hidden recurring fees.",
    title: "Buy Credits"
  },
  quizPage: {
...
const pl: SiteCopy = {
  ...
  creditsPage: {
    ...
    metaDescription: "Doładuj kredyty QuizSolver jednorazowym pakietem. Jeden kredyt to jedna odpowiedź AI do pytania, bez abonamentu i ukrytych opłat.",
    title: "Kup kredyty"
  },
  quizPage: {
